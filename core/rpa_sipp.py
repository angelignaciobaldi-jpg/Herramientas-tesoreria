...
class SesionSipp:
    ...
    async def iniciar(self) -> "SesionSipp":
        ...
        La ventana se abre maximizada y con zoom reducido (factor `zoom`, p. ej.
        0.8 = 80%) para que TODOS los registros del reporte queden dentro del área
        visible: con la ventana al 100% los últimos quedaban fuera y el RPA no
        podía hacer clic en ellos (Playwright no pulsa elementos fuera de la
        ventana con navegador visible)."""
